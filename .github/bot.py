...
# AYARLAR
# =====================================================================
# Binance, GitHub Actions'ın sunucu IP'lerini "kısıtlı bölge" sayıp
# erişimi engelliyor (451 hatası). Bu yüzden varsayılan olarak KuCoin
# kullanılıyor. Sorun yaşarsanız "kucoin" yerine "okx" veya "bybit"
# deneyebilirsiniz — hepsi ccxt üzerinden aynı şekilde çalışır.
EXCHANGE_ID = "kucoin"
QUOTE_CURRENCY = "USDT"
